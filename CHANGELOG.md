...
### Added
- Support for numeric dot path segments in expressions and conditions, such as `metric.change.0 === '+'`.
- Test coverage for numeric string indexes, decimal literals, string literals containing numeric dotted text, and metric trend rendering.
- ESLint flat config support for ESLint 10.

### Changed
- Upgraded the TypeScript/Jest/ESLint development toolchain, including Jest 30 and TypeScript 6.
- Documented numeric dot path segment support in conditional expressions.
...
[0.1.2]: https://github.com/peedief/template-engine/releases/tag/v0.1.2
